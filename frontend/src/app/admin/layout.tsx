    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-56 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <div className="p-3 border-t border-gray-700">
          <Link
            href="/genel"
            className="flex items-center gap-2 px-3 py-2 text-xs text-gray-400 hover:text-white rounded-lg hover:bg-gray-800 transition-colors mb-1"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-xs text-gray-400 hover:text-red-400 rounded-lg hover:bg-gray-800 transition-colors w-full"
          >
